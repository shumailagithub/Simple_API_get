...
side_hustles = [
    ...
    "youTube Cannel - Monetize videos through ads and sponsorships!",
    "Social Media Management - Manage accounts for brands and influenses!",
...
# with APIKEY code /// and Without APIKEY is above it
